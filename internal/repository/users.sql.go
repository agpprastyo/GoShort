...
RETURNING id, username, password_hash, email, first_name, last_name, created_at, updated_at, role
`
...
SELECT id, username, password_hash, email, first_name, last_name, created_at, updated_at, role FROM users
WHERE id = $1 LIMIT 1
`
