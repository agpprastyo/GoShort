...
type mockShortLinkService struct {
	...
	ToggleUserLinkStatusFunc func(ctx context.Context, userID, linkID uuid.UUID) (*LinkResponse, error)
	ShortCodeExistsFunc      func(ctx context.Context, code string) (bool, error)
}

// Ensure mockShortLinkService implements the service.IService interface.
var _ IService = (*mockShortLinkService)(nil)

func (m *mockShortLinkService) CreateLinkFromDTO(ctx context.Context, userID uuid.UUID, req CreateLinkRequest) (*LinkResponse, error) {
...
func (m *mockShortLinkService) GetUserLinkByID(ctx context.Context, userID, linkID uuid.UUID) (*LinkResponse, error) {
	return m.GetUserLinkByIDFunc(ctx, userID, linkID)
}

func (m *mockShortLinkService) UpdateUserLink(ctx context.Context, userID, linkID uuid.UUID, req UpdateLinkRequest) (*LinkResponse, error) {
...
func (m *mockShortLinkService) ToggleUserLinkStatus(ctx context.Context, userID, linkID uuid.UUID) (*LinkResponse, error) {
...
func TestShortLinkHandler_CreateShortLink(t *testing.T) {
	userID := uuid.New()
	mockResponse := &LinkResponse{ID: uuid.New(), OriginalURL: "https://example.com"}
	...
	testCases := []struct {
	...
	}{
		{
			...
			requestBody: CreateLinkRequest{OriginalURL: "https://example.com"},
			setupMock: func(mock *mockShortLinkService) {
				mock.CreateLinkFromDTOFunc = func(ctx context.Context, id uuid.UUID, req CreateLinkRequest) (*LinkResponse, error) {
...
func TestShortLinkHandler_GetUserLinkByID(t *testing.T) {
	userID := uuid.New()
	linkID := uuid.New()
	mockResponse := &LinkResponse{ID: linkID, OriginalURL: "https://specific.com"}
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMock: func(mock *mockShortLinkService) {
				mock.GetUserLinkByIDFunc = func(ctx context.Context, uID, lID uuid.UUID) (*LinkResponse, error) {
...
func TestShortLinkHandler_UpdateLink(t *testing.T) {
	...
	newTitle := "New Title"
	updateReq := UpdateLinkRequest{Title: &newTitle}
	mockResponse := &LinkResponse{ID: linkID, Title: helper.StringToPtr("New Title")}
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupMock: func(mock *mockShortLinkService) {
				mock.UpdateUserLinkFunc = func(ctx context.Context, uID, lID uuid.UUID, req UpdateLinkRequest) (*LinkResponse, error) {
					require.Equal(t, userID, uID)
					require.Equal(t, linkID, lID)
...
func TestShortLinkHandler_ToggleLinkStatus(t *testing.T) {
	userID := uuid.New()
	linkID := uuid.New()
	mockResponse := &LinkResponse{ID: linkID, IsActive: true}
	...
	testCases := []struct {
	...
	}{
		{
			...
			linkID: linkID.String(),
			setupMock: func(mock *mockShortLinkService) {
				mock.ToggleUserLinkStatusFunc = func(ctx context.Context, uID, lID uuid.UUID) (*LinkResponse, error) {
					require.Equal(t, userID, uID)
					require.Equal(t, linkID, lID)
					return mockResponse, nil
				}
